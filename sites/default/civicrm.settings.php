...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://webhost:Testing0!@localhost/civisite?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://webhost:Testing0!@localhost:3306/civisite?new_link=true');
  }
}
...
$civicrm_root = '/var/www/html/civisite/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/html/civisite/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://civisite.com/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'dc7c165f12da7d67d70b37ddb23a31e0');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/civisite/sites/default/files/civicrm/templates_c//mail.log');
// }
